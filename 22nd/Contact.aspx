      ...
      <br />
        <div class="grid_7">
          ...
          <div id="contact">
            ...
            <asp:TextBox CssClass="Fields" ID="txtfname" runat="server"></asp:TextBox>
            ...
            <asp:TextBox CssClass="Fields" ID="txtlname" runat="server"></asp:TextBox>
            ...
            <asp:TextBox CssClass="Fields" ID="txtemail" runat="server"></asp:TextBox>
            ...
            <asp:TextBox CssClass="Fields" ID="txtcitystate" runat="server"></asp:TextBox>
            ...
            <asp:TextBox CssClass="Fields" ID="txtmsg" runat="server" TextMode="MultiLine" Columns="50" Rows="10"></asp:TextBox>
