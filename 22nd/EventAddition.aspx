<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EventAddition.aspx.vb" Inherits="EventAddition" %>
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="jquery/lib/css/ui-lightness/jquery-ui-1.8.16.custom.css">
    <link rel="shortcut icon" href="/favicon.ico">
    <link rel="apple-touch-icon" href="/apple-touch-icon.png">
   
    <script src="jquery/lib/jquery-1.4.2.min.js"></script>
    <script src="jquery/lib/js/jquery-1.6.2.min.js"></script>
    <script src="jquery/lib/js/jquery-ui-1.8.16.custom.min.js"></script>
  </head>
  <body>
    ...
    <div class="container_12">
      ...
      <br />
        <div class="grid_7">
          <fieldset> <legend><h3>Add the event:</h3></legend>
...
<div class="demo">
 ...
 Event's Date: 
 <br /><asp:TextBox ID="datepicker" runat="server"></asp:TextBox>
  <br />
  Event's Title: <br /><asp:TextBox ID="txtTitle" Width="400px" runat="server"></asp:TextBox> <br />
   Event's Description:<br /> <asp:TextBox ID="txtmsg" TextMode="multiLine" Rows="10" Columns="60" runat="server"></asp:TextBox> 
<br />
